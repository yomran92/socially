...
class AddNewCommentUsecase implements Usecase<GetCommentEntity, AddCommentParams> {
  final CommentRepository? commentRepository;

  AddNewCommentUsecase(this.commentRepository);

  @override
  Future<Either<ErrorEntity, GetCommentEntity>> call(AddCommentParams params) async {
