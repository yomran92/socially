        ...
        children: [
          Container(
              ...
              child: Row(
                ...
                children: [
                  CustomPicture(
                      path: AssetsPath.PNGPerson, height: 25.r, width: 25.r),
                  Expanded(
                    ...
                    text: [
                      new TextSpan(
                          ...
                          style:
                              Styles.w500TextStyle().copyWith(fontSize: 16.sp)),
                      new TextSpan(
                          text: '.With Zoe Sugg ',
                          style:
          ...
          isImage
              ? CustomRichText(
                  ...
                  textWithemogi: postEntity.body! + StringLbl.textEx,
          ...
          CommonSizes.vSmallestSpace,
          Container(
            color: Styles.colorDivider.withOpacity(0.6),
            height: 1,
          ),
          ...
          Container(
              ...
              child: Row(
                children: [
                  ...
                  CommonSizes.h4Space,
                  CustomText(
                    text: postEntity.reactions!.likes.toString(),
                    isNumberFormat: true,
                    style: Styles.w500TextStyle().copyWith(
                  ...
                  InkWell(
                      ...
                      child: CustomPicture(
                        path: AssetsPath.SVGComment,
                        isSVG: true,
                        height: 25.r,
                        width: 25.r,
                      )),
                  CustomText(
                    text: postEntity.views.toString(),
                    isNumberFormat: true,
                    style: Styles.w500TextStyle().copyWith(
                        fontSize: 14.sp, color: Styles.colorTextTitle),
                  ),
